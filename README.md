...
- Reports a breakdown of AI vs human contributions per file, date range, or individual file
...
`brela init` does everything in one command — installs shell wrappers, VS Code extension, background daemon, and git hooks.
